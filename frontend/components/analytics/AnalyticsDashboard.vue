<template>
  <div class="space-y-6">
    <div class="bg-white dark:bg-gray-800 shadow rounded-lg p-6">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div class="text-center">
          ...
          <div class="text-sm text-gray-500 dark:text-gray-400">Avg Validation Score</div>
        </div>
        ...
        <div class="text-center">
          ...
          <div class="text-sm text-gray-500 dark:text-gray-400">Hallucination Rate</div>
        </div>
    ...
    <div class="bg-white dark:bg-gray-800 shadow rounded-lg p-6">
      ...
      <div class="space-y-4">
        <div v-for="agent in agentMetrics" :key="agent.name" class="flex items-center justify-between">
